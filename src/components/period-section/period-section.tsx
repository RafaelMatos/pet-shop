                ...
                <div className='px-5'>
                    <div>
                        ...
                        {period.appointments.map((apt, index) => {
                            return (
                                <AppointmentCard appointment={apt} key={index} isFirstInSection={index === 0} />
                            )
                        })}
                    </div>
                </div>
            ) :
                <p className='text-paragraph-small-size text-content-secondary p-1'>Nenhum agendamento</p>
            }
        </section>
    );
};
